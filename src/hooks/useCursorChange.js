export const useCursorChange = (settings) => {
    ...
    switch (cursor) {
        case "white":
            ...
            document.body.style.cursor = "url(/node_modules/sena-accessibility/src/assets/cursors/white-cursor.svg), auto";
            break;
        case "black":
            document.querySelectorAll(".mask__overlay").forEach((overlay) => overlay.classList.add("hidden"));
            document.querySelectorAll(".read-guide").forEach((overlay) => overlay.classList.add("hidden"));
            document.body.style.cursor = "url(/node_modules/sena-accessibility/src/assets/cursors/black-cursor.svg), auto";
            break;
        case "mask":
