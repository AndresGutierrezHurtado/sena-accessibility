...
const AccessibilityIcon = (props) => {
    ...
    return (
        <svg
            ...
            fill="none"
        >
            <circle cx="16.9711" cy="6.82898" r="5.75" />
            <path d="M0.538243 15.079H12.7093H21.2259H33.433C33.433 17.5518 24.8776 18.4158 21.2259 18.2097L24.6689 35.2106C21.8519 35.8288 19.3478 29.6467 18.4088 26.2465H15.9048C12.1487 35.3961 9.95772 36.0349 9.01871 35.2106L13.0877 18.2097C2.32036 18.7043 0.225238 16.1093 0.538243 15.079Z" />
        </svg>
    );
};
